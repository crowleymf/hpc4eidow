...
DOUBLE PRECISION dnk
DOUBLE PRECISION dxcom, dycom, dzcom
DOUBLE PRECISION xcom, ycom, zcom
DOUBLE PRECISION xnwf, xnwl, ynwf
DOUBLE PRECISION ynwl, znwf, znwl
DOUBLE PRECISION g1, g1sum, g1avg      
DOUBLE PRECISION g2, g2sum, g2avg
DOUBLE PRECISION g3, g3sum, g3avg
DOUBLE PRECISION g4f, g4fsum, g4favg
DOUBLE PRECISION g4l, g4lsum, g4lavg, g4avg
DOUBLE PRECISION g5f, g5fsum, g5favg
...
!Calculate components of center of mass in the chain coordinates
 dxcom = dble(dxmv)/dble(nw(k))
 dycom = dble(dymv)/dble(nw(k))
 dzcom = dble(dzmv)/dble(nw(k))
